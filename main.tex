...
% Authors:
% Mengge Zhang
% Based on template by Omar Roldan 
...
\begin{minipage}[t]{0.5\textwidth} 
	...
	{ \fontsize{16}{20} \textcolor{black}{\textbf{{MenggeC3PO}}}} % First name
...
\begin{minipage}[t]{0.2\textwidth} % 20% of the page width for the first row of icons
    ...
    \icon{Phone}{11}{+86 11111111111}\\
    \icon{MapMarker}{11}{abcd, efgh}\\
...
\begin{minipage}[t]{0.27\textwidth} % 27% of the page width for the second row of icons
    ...
    \icon{Github}{11}{\href{https://github.com/MenggeC3PO}{https://github.com/Mengge}}
